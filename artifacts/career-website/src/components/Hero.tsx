    ...
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-[#0B0B08]">
      <div className="absolute inset-0 z-0">
        ...
        <div
          ...
          style={{ backgroundImage: 'radial-gradient(#2A2A1E 1px, transparent 1px)', backgroundSize: '32px 32px' }}
        />
        <motion.div
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col lg:flex-row items-center gap-12">
        <div className="flex-1 max-w-3xl pt-10 lg:pt-0">
          ...
          >
            ...
            <span className="block text-3xl sm:text-4xl md:text-5xl mt-2 text-[#9A9A80]">Bridging molecular science</span>
          ...
          >
            <a
              href="#projects"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-amber-400 text-[#0B0B08] font-bold shadow-lg shadow-amber-400/20 hover:bg-amber-300 hover:shadow-xl hover:shadow-amber-400/30 hover:-translate-y-1 transition-all duration-300"
            >
              View Projects
              <ArrowRight size={18} />
            </a>
            <a
              href="#contact"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-transparent text-[#F5F0E0] font-semibold border border-[#2A2A1E] hover:bg-[#141410] hover:border-amber-400/40 hover:-translate-y-1 transition-all duration-300"
            >
              Get in Touch
            </a>
            <a
          ...
          >
            {[
              ...
              <div key={i} className="bg-[#141410] border border-[#2A2A1E] rounded-xl p-4">
                <div className="text-amber-400 font-bold mb-1">{stat.label}</div>
                <div className="text-[#9A9A80] text-xs uppercase tracking-wider">{stat.val}</div>
              </div>
            ))}
          </motion.div>
          ...
          >
            <span className="text-xs font-semibold uppercase tracking-widest text-[#9A9A80]">Find me on</span>
