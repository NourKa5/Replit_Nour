...
export const translations = {
  en: {
    ...
    exp_job2_b2: "SNR <2% enabling trace-level detection to 1µM in complex media",
    ...
    proj1_desc: "Semi-automated spectroscopy algorithm enabling trace-level detection to 1µM in biological media. SNR <2% via peak detection and pattern recognition. Headed for peer-reviewed publication.",
  ...
  ar: {
    ...
    exp_job2_b2: "نسبة إشارة إلى ضوضاء أقل من 2% تتيح الكشف على مستوى 1 ميكرومول",
    ...
    proj1_desc: "خوارزمية طيفية شبه آلية تتيح الكشف على مستوى 1 ميكرومول في الوسائط البيولوجية. نسبة S/N أقل من 2% عبر كشف القمم والتعرف على الأنماط. في طريقها للنشر العلمي المحكّم.",
  ...
  he: {
    ...
    exp_job2_b2: "SNR <2% המאפשר גילוי ברמת עקבות עד 1µM במדיה מורכבת",
    ...
    proj1_desc: "אלגוריתם ספקטרוסקופיה חצי-אוטומטי המאפשר גילוי ברמת עקבות עד 1µM במדיה ביולוגית. SNR <2% דרך גילוי פסגות וזיהוי דפוסים. בדרך לפרסום מדעי.",
