...
export const translations = {
  en: {
    ...
    proj1_desc: "Algorithm I built at Atiko Labs for SERS spectral analysis. Pipeline: ROI selection → moving-average noise reduction (iterative) → moving-median baseline subtraction → Min-Max normalization → Spectrum Profile matching. NSR <2% (noise-to-signal — noise is less than 2% of signal). Detected 4-ATP at 1 µM in blood. PCA / PLS / PCR for dimensionality reduction. Paper under peer review.",
  ...
  ar: {
    ...
    proj1_desc: "خوارزمية بنيتها في Atiko Labs لتحليل أطياف SERS. خط المعالجة: تحديد ROI ← تقليل الضوضاء بالمتوسط المتحرك ← طرح الخط الأساسي بالوسيط المتحرك ← تطبيع Min-Max ← مطابقة الملف الطيفي. NSR أقل من 2% (نسبة الضوضاء للإشارة — أي الضوضاء أقل من 2% من الإشارة). الكشف عن 4-ATP عند 1 ميكرومول في الدم. PCA/PLS/PCR لتقليل الأبعاد. الورقة قيد المراجعة.",
  ...
  he: {
    ...
    proj1_desc: "אלגוריתם שבניתי ב-Atiko Labs לניתוח ספקטרות SERS. צינור עיבוד: בחירת ROI ← צמצום רעש ממוצע נע ← חיסור קו בסיס חציון נע ← נרמול Min-Max ← השוואת פרופיל ספקטרלי. NSR <2% (רעש-לאות — רעש פחות מ-2% מהאות). גילוי 4-ATP ב-1µM בדם. PCA/PLS/PCR לצמצום ממדים. מאמר בסקירת עמיתים.",
