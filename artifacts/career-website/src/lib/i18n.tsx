...
export const translations = {
  en: {
    ...
    proj1_desc: "Imagine trying to hear one person whispering in a stadium full of noise — that's finding a single molecule in blood. I built RamanSense: a pattern recognition algorithm that takes a chaotic Raman sensor signal, strips away noise and background layer by layer, then identifies the molecule's unique chemical fingerprint. Result: NSR <2% (noise is less than 2% of the signal) and successful detection of 4-ATP at 1 µM in blood — invisible to conventional methods. Paper under peer review.",
