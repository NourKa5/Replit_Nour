...
export const translations = {
  en: {
    ...
    hero_desc: "Chemical Engineering graduate from Ben-Gurion University with 2.5 years of R&D at Atiko Labs developing Python-based SERS/Raman algorithms. Targeting entry-level roles in Data Science, ML, AI, and Chemical / Process Engineering — where rigorous problem-solving meets real-world impact.",
    ...
    about_p2: "Equally at home in the spectrometer lab, on the PLC factory floor, and shipping production code. My range is unusual: Python signal processing & ML, Siemens PLC programming, SolidWorks prototyping, FastAPI microservices, and React/Node web apps — all built from first principles.",
    about_p3: "Just completed the AI Developer certification (Jan 2025 – Mar 2026). Seeking my first full-time role — open to Data Science, ML, AI, Data Analyst, AI Engineering, or Chemical / Process Engineering positions worldwide.",
    ...
    proj_subtitle: "A selection of recent work spanning R&D signal processing, machine learning, industrial automation, and software development.",
    proj_code: "Code",
    proj_demo: "Demo",
    ...
    game_quiz_desc: "5 random questions from a 20-question pool covering Nour's work in spectroscopy, automation, AI, and software development.",
    ...
    // Looking For
    looking_badge: "Open to Hire",
    looking_title: "What I'm Looking For",
    looking_subtitle: "Two complementary worlds — bring me into either. I'm equally serious about both tracks.",
    looking_col1_title: "Data, ML & AI Roles",
    looking_col1_sub: "Junior / Entry-level",
    looking_col1_role1: "Junior Data Scientist",
    looking_col1_role2: "Junior Machine Learning Engineer",
    looking_col1_role3: "Data Analyst",
    looking_col1_role4: "AI / ML Analyst",
    looking_col1_role5: "AI Engineer / AI Developer",
    looking_col2_title: "Chemical & Engineering Roles",
    looking_col2_sub: "Entry-level",
    looking_col2_role1: "Chemical Engineer",
    looking_col2_role2: "R&D Process Engineer",
    looking_col2_role3: "Process Engineer",
    looking_col2_role4: "R&D Engineer",
    looking_col2_role5: "V&V Engineer",
    looking_col2_role6: "Application Engineer",
    looking_col2_role7: "GPS (Global Product Support) Engineer",
    looking_col2_role8: "Industrial Automation Engineer",
    looking_col2_role9: "System / Integration Engineer",
    looking_relocation: "Open to global relocation · Available immediately",
    looking_pitch_title: "30-Second Pitch Reel",
    looking_pitch_subtitle: "A quick visual intro — who I am, what I've built, and what I bring on day one.",
    looking_open_full: "Open in full screen ↗",
    looking_cta: "Start a conversation →",
  },
  ...
  ar: {
    ...
    hero_desc: "خريج هندسة كيميائية من جامعة بن غوريون مع 2.5 سنة من البحث والتطوير في Atiko Labs لتطوير خوارزميات SERS/Raman بلغة بايثون. أبحث عن وظائف مبتدئة في علم البيانات، تعلم الآلة، الذكاء الاصطناعي، والهندسة الكيميائية / هندسة العمليات — حيث يلتقي حل المشكلات الصارم بالأثر الواقعي.",
    ...
    about_p2: "مرتاح في مختبر المطياف، وعلى أرضية مصنع PLC، وفي شحن كود الإنتاج. نطاقي غير معتاد: معالجة إشارات بايثون وتعلم آلي، برمجة Siemens PLC، نمذجة SolidWorks، خدمات FastAPI المصغرة، وتطبيقات React/Node — كل ذلك من المبادئ الأساسية.",
    about_p3: "أكمل للتو شهادة مطوّر ذكاء اصطناعي (يناير 2025 – مارس 2026). أبحث عن وظيفتي الأولى بدوام كامل — منفتح على وظائف علم البيانات، تعلم الآلة، الذكاء الاصطناعي، تحليل البيانات، هندسة الذكاء الاصطناعي، أو الهندسة الكيميائية / هندسة العمليات حول العالم.",
    ...
    proj_subtitle: "مختارات من أعمالي الأخيرة تشمل معالجة إشارات البحث والتطوير، تعلم الآلة، الأتمتة الصناعية، وتطوير البرمجيات.",
    proj_code: "الكود",
    proj_demo: "تجربة",
    ...
    game_quiz_desc: "5 أسئلة عشوائية من مجموعة 20 سؤالاً تغطي عمل نور في الطيفية، الأتمتة، الذكاء الاصطناعي، وتطوير البرمجيات.",
    ...
    // Looking For
    looking_badge: "متاح للتوظيف",
    looking_title: "ما الذي أبحث عنه",
    looking_subtitle: "عالمان متكاملان — رحبوا بي في أي منهما. أنا جادّ بنفس القدر في كلا المسارين.",
    looking_col1_title: "وظائف البيانات والذكاء الاصطناعي",
    looking_col1_sub: "مبتدئ / Junior",
    looking_col1_role1: "عالم بيانات مبتدئ",
    looking_col1_role2: "مهندس تعلم آلة مبتدئ",
    looking_col1_role3: "محلل بيانات",
    looking_col1_role4: "محلل ذكاء اصطناعي / تعلم آلة",
    looking_col1_role5: "مهندس / مطوّر ذكاء اصطناعي",
    looking_col2_title: "وظائف الهندسة الكيميائية",
    looking_col2_sub: "مستوى مبتدئ",
    looking_col2_role1: "مهندس كيميائي",
    looking_col2_role2: "مهندس عمليات بحث وتطوير",
    looking_col2_role3: "مهندس عمليات",
    looking_col2_role4: "مهندس بحث وتطوير",
    looking_col2_role5: "مهندس V&V (تحقق وتصديق)",
    looking_col2_role6: "مهندس تطبيقات",
    looking_col2_role7: "مهندس دعم منتج عالمي (GPS)",
    looking_col2_role8: "مهندس أتمتة صناعية",
    looking_col2_role9: "مهندس أنظمة / تكامل",
    looking_relocation: "منفتح على الانتقال عالمياً · متاح فوراً",
    looking_pitch_title: "ريل تعريفي بـ 30 ثانية",
    looking_pitch_subtitle: "مقدمة بصرية سريعة — من أنا، وما الذي بنيته، وما الذي أقدّمه من اليوم الأول.",
    looking_open_full: "فتح بملء الشاشة ↗",
    looking_cta: "ابدأ محادثة ←",
  },
  ...
  he: {
    ...
    hero_desc: "בוגר הנדסה כימית מאוניברסיטת בן-גוריון עם 2.5 שנות מו\"פ ב-Atiko Labs בפיתוח אלגוריתמי SERS/Raman ב-Python. מחפש משרות ג'וניור ב-Data Science, ML, AI, והנדסה כימית / תהליכים — שם פתרון בעיות קפדני פוגש השפעה אמיתית.",
    ...
    about_p2: "נוח בשלוש סביבות: מעבדת ספקטרומטר, רצפת מפעל PLC, ומשלוח קוד ייצור. הטווח שלי יוצא דופן: עיבוד אותות ו-ML ב-Python, תכנות Siemens PLC, אב-טיפוס SolidWorks, microservices של FastAPI ואפליקציות React/Node — הכל מעקרונות ראשונים.",
    about_p3: "סיימתי זה עתה את תעודת מפתח ה-AI (ינואר 2025 – מרץ 2026). מחפש את תפקידי הראשון במשרה מלאה — פתוח לתפקידי Data Science, ML, AI, Data Analyst, AI Engineering, או הנדסה כימית / תהליכים בעולם.",
    ...
    proj_subtitle: "מבחר עבודות אחרונות הכוללות עיבוד אותות מו\"פ, למידת מכונה, אוטומציה תעשייתית ופיתוח תוכנה.",
    proj_code: "קוד",
    proj_demo: "הדגמה",
    ...
    game_quiz_desc: "5 שאלות אקראיות מבנק של 20 שאלות המכסות עבודת נור בספקטרוסקופיה, אוטומציה, AI ופיתוח תוכנה.",
    game_photon_title: "תופס פוטונים",
    game_photon_desc: "תפוס פוטונים טסים לפני שיברחו! כל פוטון חושף הישג אמיתי ממסלול נור.",

    // Looking For
    looking_badge: "פתוח לגיוס",
    looking_title: "מה אני מחפש",
    looking_subtitle: "שני עולמות משלימים — קבלו אותי לכל אחד מהם. אני רציני באותה מידה בשני המסלולים.",
    looking_col1_title: "תפקידי Data, ML ו-AI",
    looking_col1_sub: "ג'וניור / כניסה",
    looking_col1_role1: "Junior Data Scientist",
    looking_col1_role2: "Junior Machine Learning Engineer",
    looking_col1_role3: "Data Analyst",
    looking_col1_role4: "AI / ML Analyst",
    looking_col1_role5: "AI Engineer / AI Developer",
    looking_col2_title: "תפקידי הנדסה כימית",
    looking_col2_sub: "כניסה / ג'וניור",
    looking_col2_role1: "מהנדס כימיה",
    looking_col2_role2: "מהנדס תהליכי מו\"פ",
    looking_col2_role3: "מהנדס תהליכים",
    looking_col2_role4: "מהנדס מו\"פ",
    looking_col2_role5: "מהנדס V&V",
    looking_col2_role6: "מהנדס יישום",
    looking_col2_role7: "מהנדס תמיכת מוצר גלובלי (GPS)",
    looking_col2_role8: "מהנדס אוטומציה תעשייתית",
    looking_col2_role9: "מהנדס מערכות / אינטגרציה",
    looking_relocation: "פתוח להעתקה גלובלית · זמין מיידית",
    looking_pitch_title: "ריל פיץ' של 30 שניות",
    looking_pitch_subtitle: "מבוא ויזואלי מהיר — מי אני, מה בניתי, ומה אני מביא מהיום הראשון.",
    looking_open_full: "פתח במסך מלא ↗",
    looking_cta: "התחל שיחה ←",
  },
} as const;
